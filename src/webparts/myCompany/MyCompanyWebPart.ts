...
export interface IMyCompanyWebPartProps {
  description: string;
  ConpanyAnnouncementsId: "A7297000-01B4-4A21-BAF8-E607F8DD83B8";
}
  ...
  public render(): void {
    const element: React.ReactElement<IMyCompanyProps> = React.createElement(
      MyCompany,
      {
        ...
        ConpanyAnnouncementsId: this.properties.ConpanyAnnouncementsId,
          ...
          groups: [
            {
              ...
              groupFields: [
                ...
                PropertyPaneTextField('ConpanyAnnouncementsId', {
                  label: "ConpanyAnnouncementsId"
                })
              ]
            }
          ]
